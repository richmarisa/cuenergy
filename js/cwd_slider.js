	...
	jQuery(document).ready(function($) {
		...
		function buildNav() {
			...
			if (nextprev && slide_count > 1) {
				nextprev_html = '<div class="next-prev dfdfdffdfdfdfdfdfd"><a class="prev" href="'+caption_div+'"><span class="hidden">Previous Slide</span><span class="fa fa-angle-left"></span></a><a class="next" href="'+caption_div+'"><span class="hidden">Next Slide</span><span class="fa fa-angle-right"></span></a></div>';
			}
